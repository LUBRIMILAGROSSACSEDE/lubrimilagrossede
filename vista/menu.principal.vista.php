...
<html>
    ...
    <section class="content-header">
      <h1>
        Bienvenido a 
        <small></small>Servicios Lubricentro Milagros
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer">Productos Registrados<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="#" class="small-box-footer">Nuevos Requerimientos<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="#" class="small-box-footer"> Ventas del dia <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Haga que el tema responda</span>
            ...
            <div class="box-footer no-border">
              <div class="row">
                ...
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">En linea</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  <div id="sparkline-3"></div>
                  <div class="knob-label">Existencias</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
